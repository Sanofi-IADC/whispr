import{_ as n,c as s}from"./app.53be1ff4.js";const a={},e=s(`<h1 id="file-upload" tabindex="-1"><a class="header-anchor" href="#file-upload" aria-hidden="true">#</a> File Upload</h1><h2 id="aws-dependency" tabindex="-1"><a class="header-anchor" href="#aws-dependency" aria-hidden="true">#</a> AWS Dependency</h2><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p>This feature is currently <strong>only available with AWS</strong>.</p></div><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p>This feature is only supported by the GraphQL-API, not the REST-API.</p></div><p>You need to provide the following environment variable.</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># Optional</span>
